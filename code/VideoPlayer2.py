...
# Load a model
model = YOLO("/media/lab_brownien/data1/Work_Student2024_V2/AI_train/runs/classify/train15#/weights/best.pt") #xxx
...
#ทำการทำนาย
                ...
                prediction = class_dict[results[0].probs.data.argmax().item()]
...
#------------------------------------------------------------------------------------------------------------              
                ...
                self.window.Element("prediction").Update(f"Prediction: {prediction}", font=("Calibri", 24))

                # แปลงเฟรมเป็นรูปภาพและอัปเดต canvas
        ...
        # tkinter .after เมธอดทำให้เราสามารถทำรีเคอร์ซีฟหลังจากดีเลย์โดยไม่ถึงขีดจำกัดรีเคอร์ชั่น
        # เราต้องรอระหว่างแต่ละเฟรมเพื่อให้ได้เฟรมเรทที่เหมาะสม แต่ยังต้องนับเวลาที่ใช้ในการสร้างเฟรมก่อนหน้า
...
#------------------------------------------------------------------------------------------------------------
    ...
    def __init__(self):
        ...
        folder = r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Classes"  # get list of PNG files in folder
        ...
        file_list_column = [
            [sg.Text("Classes")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/0.png"), sg.Text("0 Angry   "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/10.png"), sg.Text("10 Scared")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/1.png"), sg.Text("1 Bored   "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/11.png"), sg.Text("11 Shy")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/2.png"), sg.Text("2 Confused"),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/12.png"), sg.Text("12 Sigh")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/3.png"), sg.Text("3 Cool    "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/13.png"), sg.Text("13 Superangry")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/4.png"), sg.Text("4 Errrr   "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/14.png"), sg.Text("14 Surprised")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/5.png"), sg.Text("5 Funny   "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/15.png"), sg.Text("15 Suspicious")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/6.png"), sg.Text("6 Happy   "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/16.png"), sg.Text("16 unhappy")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/7.png"), sg.Text("7 Normal  "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/17.png"), sg.Text("17 Worried")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/8.png"), sg.Text("8 Proud   "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/18.png"), sg.Text("18 sweet")],
            [sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/9.png"), sg.Text("9 Sad     "),sg.Image(r"/media/lab_brownien/data1/Work_Student2024_V2/AI_train/fast/Image/19.png"), sg.Text("19 tricky")],
        ]
